...
(function() {
    ...
    Render.bodies = function(render, bodies, context) {
        ...
        for (i = 0; i < bodies.length; i++) {
            ...
            if (uiState.selectedUnit && 
                ...
                Render.body(render, body, context);
            }
        }
    ...
    Render.body = function(render, body, context) {
        var c = context,
            engine = render.engine,
            options = render.options,
        ...
        for (k = body.parts.length > 1 ? 1 : 0; k < body.parts.length; k++) {
            part = body.parts[k];
            //console.log("The render part:", part.render);
            ...
            if (part.render.sprite && part.render.sprite.texture && !options.wireframes) {
                ...
                //c.font = "14px Arial";
                //c.fillText("Hello World",part.position.x,part.position.y);
                c.stroke();
            }
            ...
            if (body.render.text) {
                c.font = "14px Arial";
                c.fillStyle = '#000';
                c.fillText(body.render.text, body.position.x, body.position.y);              
            }
